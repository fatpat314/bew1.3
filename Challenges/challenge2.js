 ...
 *    expectation was correct.
    ...
    ANSWER: The name will be printed along with a delay followed by my_str.
 *
 *
 ...
 *    instead of a string. What happens? Does uppercaser() still run?
        ...
        ANSWER: reject('Name must be a string!'); Uppercase does not run
 *
 *
 ...
 *    run the code again.
        ...
        Answer: greet() still runs. But uppercaser() is rejected.
 *
 *
